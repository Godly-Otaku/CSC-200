...
Output: Computer moves, game board, who wins
*/
import java.util.*; //Import all util functions
...
Please enter the coordinates of your location (x):
0,0
|X| | |
| | | |
| | | |
...
Please enter the coordinates of your location (x):
1,1
That spot is taken! Please choose an empty spot
2,2
|X| | |
| |O| |
| | |X|
